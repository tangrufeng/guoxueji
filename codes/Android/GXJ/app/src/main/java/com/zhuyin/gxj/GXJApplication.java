...
public class GXJApplication extends Application {
	public final static String TAG = "GXJApplication";
	private static GXJApplication instance;
	...
	public static GXJApplication getInstance() {
		return instance;
	}
	...
	class MyBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BoxControler.ACTION_BOX_NO_ADDRESS.equals(intent.getAction())) {
				Intent i = new Intent(GXJApplication.this, ReadyActivity.class);
